...
public class MineSweeperStatusBar extends JPanel {
	...
	private Calendar calendar;
        ...
        private MineSweeperServerImpl mineSweeperServerImpl;
	...
	private MineSweeperStatusBar() {
		...
		initGUIComponents();
            try {
                ...
                Logger.getLogger(MineSweeperStatusBar.class.getName()).log(Level.SEVERE, null, ex);
            }
		placeGUIComponents();
	}
	...
	private void visualSetup() throws RemoteException {
		setBackground(new Color(204, 204, 204));
		setBorder(new EtchedBorder(EtchedBorder.RAISED, new Color(0, 0, 204),
				new Color(204, 204, 255)));

		// ---- mailAddressTextField ----
		mailAddressTextField.setText("by: António Ferreira & Pedro Coutinho");
		mailAddressTextField.setEditable(false);
		mailAddressTextField.setFont(new Font("Tahoma", Font.ITALIC, 10));
		mailAddressTextField.setBackground(new Color(204, 204, 204));
		mailAddressTextField.setDisabledTextColor(new Color(0, 0, 0));
		mailAddressTextField.setBorder(null);

		// ---- currentTimeLabel ----
		currentTimeLabel.setFont(new Font("Tahoma", Font.ITALIC, 10));
		currentTimeLabel.setForeground(new Color(0, 0, 0));
	}
