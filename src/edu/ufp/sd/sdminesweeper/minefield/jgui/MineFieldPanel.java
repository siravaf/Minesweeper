...
public class MineFieldPanel extends JPanel {
	...
	/**
	 * This constructor creates a mine field panel, based on a new mine field generation.
	 *
	 */
	...
	private void init() {
		...
		try {
			mineFieldGenerator = MainFrame.getInstance().getMineSweeperServerRI().getGameMap(
					MainFrame.getInstance().getRoomID()
			);
