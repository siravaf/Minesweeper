...
public class MineSweeperClientHallGUI extends javax.swing.JFrame implements WindowListener {
    ...
    private final MineSweeperClientImpl bdc;
    private final DefaultListModel<String> roomslist = new DefaultListModel<>();
    private final DefaultComboBoxModel<String> levelslist = new DefaultComboBoxModel<>();
    /**
     * Creates new form MineSweeperClientHallGUI
     * @param bdc
     */

    public MineSweeperClientHallGUI(MineSweeperClientImpl bdc) throws RemoteException {
        this.bdc = bdc;
        initComponents();
    ...
    private void initComponents() {
        ...
        jcbLevels.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jcbLevelsActionPerformed(evt);
            }
        });
    ...
    private void initCustomComponents() throws RemoteException {
        ...
        try {
            this.lblOnlineUsers.setText("Online Clients: " + this.bdc.mineSweeperServerRI.countConnectedClients());
            String[] levels = this.bdc.mineSweeperServerRI.fetchAvaliableLevels();
            for (String level : levels) {
                this.levelslist.addElement(level);
            }

            String[] rooms = this.bdc.mineSweeperServerRI.fetchAvaliableRooms();
            if (rooms.length != 0) {
    ...
    private void tfMessageKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tfMessageKeyPressed
        ...
        if (c == '\n' || c == '\r') {
            try {
                ...
                this.bdc.mineSweeperServerRI.setState(ms);
    ...
    private void btnNewRoomActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNewRoomActionPerformed
        ...
        try {
            ...
            int roomID = this.bdc.mineSweeperServerRI.createGameRoom(bdc, level);
            if (roomID >= 0) {
    ...
    private void jcbLevelsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jcbLevelsActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jcbLevelsActionPerformed
    ...
    /**
    * Fazer update em todas as halls
    */
